...
from tinygrad.runtime.support.compiler_cuda import CUDACompiler, PTXCompiler, PTX, NVPTXCompiler, NVCompiler, SASSCompiler, SASSCompilerIntercept
...
class NVDevice(HCQCompiled[NVSignal]):
  ...
  def __init__(self, device:str=""):
    ...
    if getenv("SASS_RENDER"):
      ...
      if getenv("SASS"):
        compiler_t = SASSCompilerIntercept
      else:
